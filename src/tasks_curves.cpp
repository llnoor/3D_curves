...
void Tasks::task3() {
    std::cout << "Task3 (at M_PI/4 x equal -dx/dt, y equal dy/dt, z equal M_PI*(dz/dt)/4):" << std::endl;
    std::for_each(first_container.begin(), first_container.end(), [&](std::shared_ptr<Curves>& temp_curve){
...
void Tasks::task4() {
    ...
    std::cout << "Test4: Task4 should contain only circles (i.e. at M_PI/4: x = y, z = 0):" << std::endl;
